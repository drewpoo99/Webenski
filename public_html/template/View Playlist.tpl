...
<body>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-4">
                <h1>{foreach $Playlist_Name as $PlaylistName => $playlist}
                        <li>{$playlist}</li>
                    {/foreach}
                </h1>
                <h5>Created by {foreach $User_Name as $UserName =>$user}
                    <li>{$user}</li>
                    {/foreach}
                </h5>
            </div>
        ...
        <div class="col-sm-2">
            <h6>Title</h6>
            <li class="song">
                <li>{foreach $Song_Name as $SongName =>$song}
                    {$song}
                {/foreach}
                </li>
            </ul>
        ...
        <div class="col-sm-2">
            <h6>Artist Name</h6>
            <ul class="song">
                <li>{foreach $Artist_ID as $ArtistID => $artist}
                    <li>{$artist}</li>
                {/foreach}
                </li>
            </ul>
        ...
        <div class="col-sm-2">
            <h6>Album Title</h6>
            <ul class="song">
                <li>{foreach $Album_Name as $AlbumName => $album}</li>
                     <li>{$album}</li>
                    {/foreach}
                </li>
            </ul>
        ...
        <div class="col-sm-2">
            <h6>Song Time</h6>
            <ul class="song">
                <li>{foreach $Song_Time as $SongTime =>$time}</li>
                    <li>{$time}</li>
                {/foreach}
                </li>
            </ul>
